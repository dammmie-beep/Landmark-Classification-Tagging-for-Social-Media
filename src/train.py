...
def train_one_epoch(train_dataloader, model, optimizer, loss):
    ...
    # YOUR CODE HERE: set the model to training model
    model.train()
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False):
    ...
    scheduler  = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', verbose = True,patience =3 )#threshold =0.01) # YOUR CODE HERE
